...
class TataUsahaCutiController extends Controller
{
    /**
    ...
    {
        $user = User::where('uuid', $uuid)->first();
        $Cuti = Cuti::where('user_id', $user->id)->first();
    ...
    {
        $user = User::where('uuid', $uuid)->first();
        $Cuti = Cuti::where('user_id', $user->id)->first()->update([
            'user_id' => $user->id,
            'date_start' => $request->date_start,
            'date_end' => $request->date_end,
            'reason' => $request->reason,
